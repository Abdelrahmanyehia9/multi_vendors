...
class HomeProductBySubCategoryCubit extends Cubit<BaseState<List<ProductModel>>> {
  final HomeRepository _repository;

  HomeProductBySubCategoryCubit(this._repository)
    : super(const BaseState.initial());

  Future<void> getProductByCategory(int category) async {
    safeEmit(const BaseState.loading());
    final result = await _repository.getProductBySubCategory(catId: category);
